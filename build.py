...
try:
    ...
    import pip
    pip.main(['install', 'git+https://github.com/EriHoss/msbuildpy.git@'+msbuildpy_version, '--upgrade', '--target', os.path.join(script_path, 'BuildScriptLibs')])
    import msbuildpy
