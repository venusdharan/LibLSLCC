...
Expect to get build warnings about missing XML comments, some of these
are valid and some of them are bogus warnings generated by the code ANTLR
generates for the parser.  

It is because XML documentation generation is turned on for LibLSLCC, 
and some classes and methods are not entirely documented yet.  Especially
the ones generated by ANTLR :).

I am unsure how to suppress all of the documentation warnings at once, at the moment.


Also expect the LibraryDataScrapingTools project to warn you about a missing 
"Mono.Data.Sqlite" reference when building on Windows.  
